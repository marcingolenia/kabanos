...
import { mountOn } from "./.fable/Sutil.1.0.0-beta-012/DOM.fs.js";
...
describe("Initial board should have", () => {
    it("Queue column", () => PromiseBuilder__Run_212F1D4B(promise, PromiseBuilder__Delay_62FBFDE1(promise, () => PromiseBuilder__Using_74F7E79D(promise, render(app), (_arg1) => {
        Expect_innerText("Queue", _arg1.El);
